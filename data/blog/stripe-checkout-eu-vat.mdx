...
- located in the EU
- is a business customer or not (and collect the VAT number of the country)
...
The Stripe support team contacted me and said that they're working on a better solution for this. Chances are that they calculate the taxes based on our home country and we don't have to do this on our own anymore.

I am excited and looking forward to future changes by Stripe, until then I hope some of you can find some value in this blog post. ✌️
