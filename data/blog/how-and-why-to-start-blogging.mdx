...
When it comes to programming, for me it’s often like this: I stumble about a problem and search deliberately for a solution, but as soon as I’ve got the solution, I just move on with the next task and forget about the problem pretty fast. What if you put the „sharing“ as part of your problem solving? Your problem is only really solved if you write down some words about it and save it as a draft. And sometimes later, you might add some more content to it and write a blog post.
...
Long story short: someone will definitely benefit from your blogging. There might be similar blog posts to the same topic, but your findings, your writing style and how you describe it is unique. There is definitely someone out there who is currently in the same process as you were before writing your blog post and would be really thankful for it.

So whenever you’ve achieved something and your mind tells you: _"mhh this can be done by anyone, I am sure no one would benefit from it"_, then give your mind a kick and jump into the cold water! You gain many benefits by doing so. 🙂
...
I must admit, you probably need to have fun with writing up some content. Else it won’t be a sustainable thing you do over a longer period of time. But have you ever tried it?
...
Ok now comes probably the most important tip now:
**Don't. Overthink. It.**

The biggest enemy of your blogging journey is your mind. When you’re again start overthinking it, when you want to be prepared for every situation, want to do everything right in the beginning, it can end with demotivation pretty fast.
