...
summary: I describe the tech stack and how we do the deployment of our first SaaS called TrueQ. Additionally I explain what we regret about our decisions / would to differently nowadays.
...
We're very glad that the first MVP of our new product [snappify](https://snappify.io) comes with barely any backend logic and is completely hosted on Vercel, but soon we need a more sophisticated solution and I am going to inform you how our updated tech stack looks like as soon as we’ve settled. ✌️