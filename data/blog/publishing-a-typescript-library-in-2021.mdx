...
When we wanted to create a npm package for our product [snappify](https://snappify.io/) I was a bit scared because I remembered all the pain points of creating such a library some years ago. I knew of [react-hot-toast](https://react-hot-toast.com/) by [Timo Lins](https://timo.sh/) and asked him if he had some tips to get started with creating a TypeScript npm package.
